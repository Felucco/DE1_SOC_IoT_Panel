...
int AMQTT_Init(AMQTT *amqtt,const char* brok_addr, uint16_t port, const char* client_id);
//AMQTT_Result AMQTT_Subscribe(AMQTT *amqtt, const char* topic);
int AMQTT_Publish(AMQTT *amqtt, const char* msg, const char* topic);
char* AMQTT_Poll(AMQTT *amqtt, uint32_t max_timeout_ms);
