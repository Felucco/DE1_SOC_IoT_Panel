	core_sys u0 (
		.char_mem_p1_address             (<connected-to-char_mem_p1_address>),             //  char_mem_p1.address
		.char_mem_p1_clken               (<connected-to-char_mem_p1_clken>),               //             .clken
		.char_mem_p1_chipselect          (<connected-to-char_mem_p1_chipselect>),          //             .chipselect
		.char_mem_p1_write               (<connected-to-char_mem_p1_write>),               //             .write
		.char_mem_p1_readdata            (<connected-to-char_mem_p1_readdata>),            //             .readdata
		.char_mem_p1_writedata           (<connected-to-char_mem_p1_writedata>),           //             .writedata
		.char_mem_p2_address             (<connected-to-char_mem_p2_address>),             //  char_mem_p2.address
		.char_mem_p2_chipselect          (<connected-to-char_mem_p2_chipselect>),          //             .chipselect
		.char_mem_p2_clken               (<connected-to-char_mem_p2_clken>),               //             .clken
		.char_mem_p2_write               (<connected-to-char_mem_p2_write>),               //             .write
		.char_mem_p2_readdata            (<connected-to-char_mem_p2_readdata>),            //             .readdata
		.char_mem_p2_writedata           (<connected-to-char_mem_p2_writedata>),           //             .writedata
		.clk_clk                         (<connected-to-clk_clk>),                         //          clk.clk
		.from_hps_ext_export             (<connected-to-from_hps_ext_export>),             // from_hps_ext.export
		...
		.to_hps_ext_export               (<connected-to-to_hps_ext_export>),               //   to_hps_ext.export
		.font_mem_p_address              (<connected-to-font_mem_p_address>),              //   font_mem_p.address
		.font_mem_p_debugaccess          (<connected-to-font_mem_p_debugaccess>),          //             .debugaccess
		.font_mem_p_clken                (<connected-to-font_mem_p_clken>),                //             .clken
		.font_mem_p_chipselect           (<connected-to-font_mem_p_chipselect>),           //             .chipselect
		.font_mem_p_write                (<connected-to-font_mem_p_write>),                //             .write
		.font_mem_p_readdata             (<connected-to-font_mem_p_readdata>),             //             .readdata
		.font_mem_p_writedata            (<connected-to-font_mem_p_writedata>),            //             .writedata
		.font_mem_p_byteenable           (<connected-to-font_mem_p_byteenable>)            //             .byteenable
	);
